...
\def\extractdefault#1#2(default #3)\@nil{%
  \pgfmanualentryheadline{\definitionspan{\texttt{\declarekey{#1}\opt{=}}\opt{#2}}\hfill \defaultspan{(\extrakeytext default {\ttfamily#3})}}%
}

\def\extractinitial#1#2(initially #3)\@nil{%
%  \pgfmanualentryheadline{{\ttfamily\declarekey{#1}=}#2\hfill (\extrakeytext no default, initially {\ttfamily#3})}%
  \pgfmanualentryheadline{\definitionspan{\texttt{\declarekey{#1}=}#2}\hfill \defaultspan{(\extrakeytext initially {\ttfamily#3})}}%
}

\def\extractequalinitial#1 (initially #2)\@nil{%
  \pgfmanualentryheadline{\definitionspan{\texttt{\declarekey{#1}}}\hfill \defaultspan{(\extrakeytext initially {\ttfamily#2})}}%
  \def\mykey{#1}%
  \def\mypath{}%
  \def\myname{}%
  \firsttimetrue%
...
\def\extractpredefinedmethod#1(#2)\@nil{%
  \pgfmanualentryheadline{\definitionspan{Method \declare{\ttfamily #1}\texttt(#2\texttt)} \hfill\defaultspan{(predefined for all classes)}}
...
\def\extractmethod#1(#2)\@nil{%
  ...
  \ifx\test\currentclass
    \pgfmanualentryheadline{\definitionspan{Constructor \declare{\ttfamily #1}\texttt(#2\texttt)}}
  \else
    \pgfmanualentryheadline{\definitionspan{Method \declare{\ttfamily #1}\texttt(#2\texttt)}}
  \fi
  \index{#1@\protect\texttt{#1} method}%
  \index{Methods!#1@\protect\texttt{#1}}
...
\def\extractattribute#1=#2;\@nil{%
  \def\test{#2}%
  \ifx\test\@empty
    \pgfmanualentryheadline{\definitionspan{Private attribute \declare{\ttfamily #1}} \hfill \defaultspan{(initially empty)}}
  \else
    \pgfmanualentryheadline{\definitionspan{Private attribute \declare{\ttfamily #1}} \hfill \defaultspan{(initially {\ttfamily #2})}}
  \fi
...
\newenvironment{predefinednode}[1]{
  \begin{pgfmanualentry}
    \pgfmanualentryheadline{\definitionspan{Predefined node {\ttfamily\declare{#1}}}}%
...
\newenvironment{coordinatesystem}[1]{
  \begin{pgfmanualentry}
    \pgfmanualentryheadline{\definitionspan{Coordinate system {\ttfamily\declare{#1}}}}%
...
\newenvironment{snake}[1]{
  \begin{pgfmanualentry}
    \pgfmanualentryheadline{\definitionspan{Snake {\ttfamily\declare{#1}}}}%
...
\newenvironment{decoration}[1]{
  \begin{pgfmanualentry}
    \pgfmanualentryheadline{\definitionspan{Decoration {\ttfamily\declare{#1}}}}%
...
\newenvironment{filedescription}[1]{
  \begin{pgfmanualentry}
    \pgfmanualentryheadline{\definitionspan{File {\ttfamily\declare{#1}}}}%
