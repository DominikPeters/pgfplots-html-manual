...
\newenvironment{addplotoperation}[3][]{
  \begin{pgfmanualentry}
    ...
    \pgfmanualentryheadline{\definitionspan{\textcolor{gray}{\texttt{\char`\\addplot\ }}%
      \declare{\texttt{#2}} \texttt{#3;}}}%
      \unskip
     \nobreak
    \pgfmanualentryheadline{\definitionspan{\textcolor{gray}{\texttt{\char`\\addplot}\oarg{options} }%
      \declare{\texttt{#2}} \texttt{#3} \textcolor{gray}{\meta{trailing path commands}}\texttt{;}}}%
      \unskip
     \nobreak
    \pgfmanualentryheadline{\definitionspan{\textcolor{gray}{\texttt{\char`\\addplot3}} \dots}}%
    \def\pgfmanualtest{#1}%
...
\newenvironment{addplot+}{
  \begin{pgfmanualentry}
    ...
    \def\parg##1{{\normalfont\ltxdoc@parg{##1}}}%
    \def\meta##1{{\normalfont\ltxdoc@meta{##1}}}%
    \pgfmanualentryheadline{\definitionspan{\texttt{\declare{\char`\\addplot+}\oarg{options} \textcolor{gray}{\dots};}}}%
...
\newenvironment{addplot3generic}{
  \begin{pgfmanualentry}
    ...
    \def\parg##1{{\normalfont\ltxdoc@parg{##1}}}%
    \def\meta##1{{\normalfont\ltxdoc@meta{##1}}}%
    \pgfmanualentryheadline{\definitionspan{\texttt{\declare{\char`\\addplot3}\oarg{options} \meta{input data} \meta{trailing path commands};}}}%
...
\newenvironment{addplot3operation}[3][]{
  \begin{pgfmanualentry}
    ...
    \def\parg##1{{\normalfont\ltxdoc@parg{##1}}}%
    \def\meta##1{{\normalfont\ltxdoc@meta{##1}}}%
    \pgfmanualentryheadline{\definitionspan{\textcolor{gray}{\texttt{\char`\\addplot3\ }}%
      \declare{\texttt{#2}} \texttt{#3;}}}%
      \unskip
     \nobreak
    \pgfmanualentryheadline{\definitionspan{\textcolor{gray}{\texttt{\char`\\addplot3}\oarg{options} }%
      \declare{\texttt{#2}} \texttt{#3} \textcolor{gray}{\meta{trailing path commands}}\texttt{;}}}%
    \def\pgfmanualtest{#1}%
    \ifx\pgfmanualtest\@empty%
...
\newenvironment{codekey}[1]{%
  \begin{pgfmanualentry}
     \pgfmanualentryheadline{\definitionspan{\texttt{\declarekey{#1}\textcolor{gray}{/\pgfmanualpdfref{/handlers/.code}{.code}}=\marg{...}}\hfill}}%
    \def\mykey{#1}%
    \def\mypath{}%
    \def\myname{}%
    \firsttimetrue%
...
\newenvironment{codeargskey}[2]{%
  \begin{pgfmanualentry}
     ...
     \pgfmanualentryheadline{\definitionspan{\texttt{\declarekey{#1}\textcolor{gray}{/\pgfmanualpdfref{/handlers/.code}{.code args}}=\texttt{\{\argpattern\}}\marg{...}}\hfill}}%
    \def\mykey{#1}%
    \def\mypath{}%
    \def\myname{}%
    \firsttimetrue%
...
\newenvironment{pgfplotscodetwokey}[1]{%
  \begin{pgfmanualentry}
     \pgfmanualentryheadline{\definitionspan{\texttt{\declarekey{/pgfplots/#1}\textcolor{gray}{/\pgfmanualpdfref{/handlers/.code 2 args}{.code 2 args}}=\marg{...}}\hfill}}%
...
\newenvironment{pgfplotsxycodekeylist}[1]{%
    ...
    \def\pgfmanualentryheadline@##1\hfill##2\pgfplots@EOI{%
        \oldpgfmanualentryheadline{\definitionspan{\texttt{\declarekey{##1}\textcolor{gray}{/\pgfmanualpdfref{/handlers/.code}{.code}}=\marg{...}}\hfill}}%
    }
...
\newenvironment{pgfplotsxyexpressionkeylist}[1]{%
    ...
    \def\pgfmanualentryheadline@##1\hfill##2\pgfplots@EOI{%
        \oldpgfmanualentryheadline{\definitionspan{\texttt{\declarekey{##1}\textcolor{gray}{/.expression}=\marg{math expression}}\hfill}}%
    }
    \begin{pgfplotsxykeylist}{#1}%
}
{
...
\newenvironment{pgfplotsxyappendexpressionkeylist}[1]{%
    ...
    \def\pgfmanualentryheadline@##1\hfill##2\pgfplots@EOI{%
        \oldpgfmanualentryheadline{\definitionspan{\texttt{\declarekey{##1}\textcolor{gray}{/.append expression}=\marg{math expression}}\hfill}}%
    }
    \begin{pgfplotsxykeylist}{#1}%
}
{
...
\newenvironment{anchorlist}[1]{
  \begin{pgfmanualentry}
      \foreach \xx in {#1} {%
        \pgfmanualentryheadline{\definitionspan{Anchor \texttt{\declare{\xx}}}}%
...
\newenvironment{coordinatesystemlist}[1]{
  \begin{pgfmanualentry}
      \foreach \xx in {#1} {%
        \pgfmanualentryheadline{\definitionspan{Coordinate system \texttt{\declare{\xx}}}}%
...
\newenvironment{texif}[1]{%
    \begin{pgfmanualentry}
    \pgfmanualentryheadline{\definitionspan{\declare{\texttt{\textbackslash if#1}}\meta{true code}\texttt{\textbackslash else}\meta{else code}\texttt{\textbackslash fi}}}%
    \index{if#1}%
...
\newenvironment{plottype}[2][/tikz]{%
    ...
    \end{keylist}
  \begin{pgfmanualentry}
    \pgfmanualentryheadline{\definitionspan{\textcolor{gray}{\texttt{\char`\\addplot+[\declare{#2}]}}}}%
    \pgfmanualbody
}
{
  \end{pgfmanualentry}
...
\newenvironment{pgfplotstablecolumnkey}{%
  \begin{pgfmanualentry}
     \pgfmanualentryheadline{\definitionspan{\texttt{\textcolor{gray}{/pgfplots/table/}\declare{columns/\meta{column name}}\textcolor{gray}{/.style}=\marg{key-value-list}}\hfill}}%
...
\newenvironment{pgfplotstabledisplaycolumnkey}{%
  \begin{pgfmanualentry}
     \pgfmanualentryheadline{\definitionspan{\texttt{\textcolor{gray}{/pgfplots/table/}\declare{display columns/\meta{index}}\textcolor{gray}{/.style}=\marg{key-value-list}}\hfill}}%
...
\newenvironment{pgfplotstablealiaskey}{%
  \begin{pgfmanualentry}
     \pgfmanualentryheadline{\definitionspan{\texttt{\textcolor{gray}{/pgfplots/table/}\declare{alias/\meta{col name}}\textcolor{gray}{/.initial}=\marg{real col name}}\hfill}}%
...
\newenvironment{pgfplotstablecreateonusekey}{%
  \begin{pgfmanualentry}
     \pgfmanualentryheadline{\definitionspan{\texttt{\textcolor{gray}{/pgfplots/table/}\declare{create on use/\meta{col name}}\textcolor{gray}{/.style}=\marg{create options}}\hfill}}%
...
\newenvironment{pgfplotslibrary}[1]{%
  \begin{pgfmanualentry}
    \pgfmanualentryheadline{\definitionspan{\texttt{\char`\\usepgfplotslibrary\char`\{\declare{#1}\char`\}\space\space \char`\%\space\space  \LaTeX\space and plain \TeX}}}%
    \index{#1@\protect\texttt{#1} library}%
    \index{Libraries!#1@\protect\texttt{#1}}%
    \pgfmanualentryheadline{\definitionspan{\texttt{\char`\\usepgfplotslibrary[\declare{#1}]\space \char`\%\space\space Con\TeX t}}}%
    \pgfmanualentryheadline{\definitionspan{\texttt{\char`\\usetikzlibrary\char`\{\declare{pgfplots.#1}\char`\}\space\space \char`\%\space\space \LaTeX\space and plain \TeX}}}%
    \pgfmanualentryheadline{\definitionspan{\texttt{\char`\\usetikzlibrary[\declare{pgfplots.#1}]\space \char`\%\space\space Con\TeX t}}}%
    \pgfmanualpdflabel{#1}{}%
    \pgfmanualbody
}
{
