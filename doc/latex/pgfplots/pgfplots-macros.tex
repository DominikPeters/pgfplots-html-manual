...
\newenvironment{addplotoperation}[3][]{
  \begin{pgfmanualentry}
    ...
    \pgfmanualentryheadline{\textcolor{gray}{\texttt{\char`\\addplot\ }}%
    ...
    \pgfmanualentryheadline{\textcolor{gray}{\texttt{\char`\\addplot}\oarg{options} }%
      ...
      \unskip
     \nobreak
    \pgfmanualentryheadline{\textcolor{gray}{\texttt{\char`\\addplot3}} \dots}%
    \def\pgfmanualtest{#1}%
...
\newenvironment{addplot+}{
  \begin{pgfmanualentry}
    ...
    \def\parg##1{{\normalfont\ltxdoc@parg{##1}}}%
    \def\meta##1{{\normalfont\ltxdoc@meta{##1}}}%
    \pgfmanualentryheadline{\texttt{\declare{\char`\\addplot+}\oarg{options} \textcolor{gray}{\dots};}}%
...
\newenvironment{addplot3generic}{
  \begin{pgfmanualentry}
    ...
    \def\parg##1{{\normalfont\ltxdoc@parg{##1}}}%
    \def\meta##1{{\normalfont\ltxdoc@meta{##1}}}%
    \pgfmanualentryheadline{\texttt{\declare{\char`\\addplot3}\oarg{options} \meta{input data} \meta{trailing path commands};}}%
...
\newenvironment{addplot3operation}[3][]{
  \begin{pgfmanualentry}
    ...
    \def\parg##1{{\normalfont\ltxdoc@parg{##1}}}%
    \def\meta##1{{\normalfont\ltxdoc@meta{##1}}}%
    \pgfmanualentryheadline{\textcolor{gray}{\texttt{\char`\\addplot3\ }}%
      \declare{\texttt{#2}} \texttt{#3;}}%
      \unskip
     \nobreak
...
\newenvironment{codekey}[1]{%
  \begin{pgfmanualentry}
     \pgfmanualentryheadline{\texttt{\declarekey{#1}\textcolor{gray}{/\pgfmanualpdfref{/handlers/.code}{.code}}=\marg{...}}\hfill}%
    \def\mykey{#1}%
    \def\mypath{}%
    \def\myname{}%
    \firsttimetrue%
...
\newenvironment{codeargskey}[2]{%
  \begin{pgfmanualentry}
     ...
     \pgfmanualentryheadline{\texttt{\declarekey{#1}\textcolor{gray}{/\pgfmanualpdfref{/handlers/.code}{.code args}}=\texttt{\{\argpattern\}}\marg{...}}\hfill}%
    \def\mykey{#1}%
    \def\mypath{}%
    \def\myname{}%
    \firsttimetrue%
...
\newenvironment{pgfplotscodetwokey}[1]{%
  \begin{pgfmanualentry}
     \pgfmanualentryheadline{\texttt{\declarekey{/pgfplots/#1}\textcolor{gray}{/\pgfmanualpdfref{/handlers/.code 2 args}{.code 2 args}}=\marg{...}}\hfill}%
...
\newenvironment{pgfplotsxycodekeylist}[1]{%
    ...
    \def\pgfmanualentryheadline@##1\hfill##2\pgfplots@EOI{%
        \oldpgfmanualentryheadline{\texttt{\declarekey{##1}\textcolor{gray}{/\pgfmanualpdfref{/handlers/.code}{.code}}=\marg{...}}\hfill}%
    }
...
\newenvironment{pgfplotsxyexpressionkeylist}[1]{%
    ...
    \def\pgfmanualentryheadline@##1\hfill##2\pgfplots@EOI{%
        \oldpgfmanualentryheadline{\texttt{\declarekey{##1}\textcolor{gray}{/.expression}=\marg{math expression}}\hfill}%
    }
    \begin{pgfplotsxykeylist}{#1}%
}
{
...
\newenvironment{pgfplotsxyappendexpressionkeylist}[1]{%
    ...
    \def\pgfmanualentryheadline@##1\hfill##2\pgfplots@EOI{%
        \oldpgfmanualentryheadline{\texttt{\declarekey{##1}\textcolor{gray}{/.append expression}=\marg{math expression}}\hfill}%
    }
    \begin{pgfplotsxykeylist}{#1}%
}
{
...
\newenvironment{anchorlist}[1]{
  \begin{pgfmanualentry}
      \foreach \xx in {#1} {%
        \pgfmanualentryheadline{Anchor \texttt{\declare{\xx}}}%
...
\newenvironment{coordinatesystemlist}[1]{
  \begin{pgfmanualentry}
      \foreach \xx in {#1} {%
        \pgfmanualentryheadline{Coordinate system \texttt{\declare{\xx}}}%
...
\renewenvironment{coordinatesystem}[1]{
  \begin{pgfmanualentry}
    \pgfmanualentryheadline{Coordinate system \texttt{\declare{#1}}}%
...
\newenvironment{plottype}[2][/tikz]{%
    ...
    \end{keylist}
  \begin{pgfmanualentry}
    \pgfmanualentryheadline{\textcolor{gray}{\texttt{\char`\\addplot+[\declare{#2}]}}}%
    \pgfmanualbody
}
{
  \end{pgfmanualentry}
...
\newenvironment{pgfplotstablecolumnkey}{%
  \begin{pgfmanualentry}
     \pgfmanualentryheadline{\texttt{\textcolor{gray}{/pgfplots/table/}\declare{columns/\meta{column name}}\textcolor{gray}{/.style}=\marg{key-value-list}}\hfill}%
...
\newenvironment{pgfplotstabledisplaycolumnkey}{%
  \begin{pgfmanualentry}
     \pgfmanualentryheadline{\texttt{\textcolor{gray}{/pgfplots/table/}\declare{display columns/\meta{index}}\textcolor{gray}{/.style}=\marg{key-value-list}}\hfill}%
...
\newenvironment{pgfplotstablealiaskey}{%
  \begin{pgfmanualentry}
     \pgfmanualentryheadline{\texttt{\textcolor{gray}{/pgfplots/table/}\declare{alias/\meta{col name}}\textcolor{gray}{/.initial}=\marg{real col name}}\hfill}%
...
\newenvironment{pgfplotstablecreateonusekey}{%
  \begin{pgfmanualentry}
     \pgfmanualentryheadline{\texttt{\textcolor{gray}{/pgfplots/table/}\declare{create on use/\meta{col name}}\textcolor{gray}{/.style}=\marg{create options}}\hfill}%
...
\newenvironment{pgfplotslibrary}[1]{%
  \begin{pgfmanualentry}
    \pgfmanualentryheadline{\texttt{\char`\\usepgfplotslibrary\char`\{\declare{#1}\char`\}\space\space \char`\%\space\space  \LaTeX\space and plain \TeX}}%
    \index{#1@\protect\texttt{#1} library}%
    \index{Libraries!#1@\protect\texttt{#1}}%
    \pgfmanualentryheadline{\texttt{\char`\\usepgfplotslibrary[\declare{#1}]\space \char`\%\space\space Con\TeX t}}%
    \pgfmanualentryheadline{\texttt{\char`\\usetikzlibrary\char`\{\declare{pgfplots.#1}\char`\}\space\space \char`\%\space\space \LaTeX\space and plain \TeX}}%
    \pgfmanualentryheadline{\texttt{\char`\\usetikzlibrary[\declare{pgfplots.#1}]\space \char`\%\space\space Con\TeX t}}%
    \pgfmanualpdflabel{#1}{}%
    \pgfmanualbody
}
{
...
\def\extracthandler#1#2\@nil{%
  \pgfmanualentryheadline{Key handler \meta{key}\texttt{/\declare{#1}}#2}%
...
\def\extractenvironement#1#2\@@{%
  \pgfmanualentryheadline{\texttt{\char`\\begin\char`\{\declare{#1}\char`\}}#2}%
  \pgfmanualentryheadline{\texttt{\ \ }\meta{environment contents}}%
  \pgfmanualentryheadline{\texttt{\char`\\end\char`\{\declare{#1}\char`\}}}%
...
\renewenvironment{predefinednode}[1]{
  \begin{pgfmanualentry}
    \pgfmanualentryheadline{Predefined node \texttt{\declare{#1}}}%
