...
\href{https://tikz.dev/tikz-plots#sec-22.8}{the PGF/TikZ manual (Section~18.8)}.

Plot types are part of the plot style, so they are set with options. Most of
the basic 2d plot types are part of \Tikz{}, see \href{https://tikz.dev/tikz-plots#sec-22.8}{the PGF/TikZ manual (Section~18.8)}, and
...
As described in \href{https://tikz.dev/tikz-plots#sec-22.8}{the PGF/TikZ manual} in all detail, this plot handler results in a
``smooth'' outline. However, it ``not very intelligent'' (compare~\href{https://tikz.dev/tikz-plots#sec-22.8}{the PGF/TikZ manual})
...
\begin{key}{/tikz/tension=\marg{tension} (initially 0.55)}
    ...
    Please refer to \href{https://tikz.dev/tikz-plots#sec-22.8}{the PGF/TikZ manual} for details.
\end{key}
...
\begin{pgfplotsxykey}{\x ticklabel interval boundaries}
    These are style keys which set |x tick label as interval| and configure
...
|\usepgfplotslibrary{ternary}|; please refer to Section~\ref{sec:tieline}.
