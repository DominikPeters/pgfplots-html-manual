...
\end{codeexample}
    ...
    \item For normal (non-logarithmic) axes, \PGFPlots{} applies floating
        ...
        $a_x,a_y, a_z\in \mathbb{R}$. Page~\pageref{pgfplots:disabledatascaling} contains a
...
\begin{pgfplotskeylist}{%
    ...
    functions $f\colon [x_1,x_2] \to \mathbb{R}$ and \meta{$x_1$} and \meta{$x_2$} are
    set with |domain|. Three dimensional plot expressions use functions
    $f\colon [x_1,x_2] \times [y_1,y_2] \to \mathbb{R}$ and \meta{$y_1$} and
...
\begin{addplotoperation}[]{graphics}{\marg{file name}}
    ...
    external program like Matlab\textregistered{} or |gnuplot|. The graphics,
