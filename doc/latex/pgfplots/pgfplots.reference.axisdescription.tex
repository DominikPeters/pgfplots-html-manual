...
\end{codeexample}
    ...
    options of \href{https://tikz.dev/}{TikZ} apply. The point on the node's boundary which is
    actually shifted to the |at| coordinate needs to be provided with an anchor
    (cf~\href{https://tikz.dev/tikz-shapes}{the PGF/TikZ manual, Section ``Nodes and edges''}):
    %
\begin{codeexample}[]
\begin{tikzpicture}
    \begin{axis}[
...
\end{codeexample}
    ...
    components like |north east|. Please refer to \href{https://tikz.dev/}{the PGF/TikZ manual} for a complete
...
topic in \href{https://tikz.dev/}{the PGF/TikZ manual} or some more advice in
...
\end{codeexample}
    %
    \noindent See \href{https://tikz.dev/}{the PGF/TikZ manual} to learn more about |align| and |text width|.
    ...
    \begin{pgfplotsxykeylist}{\x label near ticks,compat=1.3}
        ...
        look at the definition of |near ticklabel| for an example.
...
\end{codeexample}
    ...
    \begin{pgfplotsxykeylist}{\x label absolute,compat=pre 1.3}
        ...
        configuration. Take a look at the definition of |near ticklabel| for an example.
...
\end{codeexample}
    ...
    affects nodes and matrices (see~\href{https://tikz.dev/tikz-matrices}{the PGF/TikZ manual}). The
