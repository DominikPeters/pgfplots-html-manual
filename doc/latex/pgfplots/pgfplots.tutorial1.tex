...
topics). The complete set of number printing options is available in both 
\href{https://tikz.dev/}{the TikZ manual} and the \href{https://tikz.dev/pgfplots/pgfplotstable}{manual for \PGFPlotstable{}}. 
A brief extract can be found in
...
in the \href{https://tikz.dev/library-external}{the PGF/TikZ manual}.
