...
\end{codeexample}
    ...
    to \href{https://tikz.dev/pgfkeys}{the PGF/TikZ manual, Section ``pgfkeys''} or the shorter
...
The following extract of \href{https://tikz.dev/}{the PGF/TikZ manual} explains how to configure number formats.
...
\end{codeexample}
    ...
    \meta{lower e} $\le e \le$ \meta{upper e}, the number is
...
\section[pgfplotstable-data-processing]{From Input Data To Output Tables: Data Processing}
...
\end{codeexample}
    ...
    more details yet, sorry. Please refer to \href{https://tikz.dev/}{the PGF/TikZ manual} for more details.
\end{stylekey}
...
\begin{codekey}{/pgfplots/table/row predicate}
    ...
    %
\begin{codeexample}[pre={\begin{lateximage}},post={\end{lateximage}},newline=]
% requires \usepackage{booktabs}
\pgfplotstabletypeset[
    every head row/.style={
        before row=\toprule,after row=\midrule},
...
\end{codeexample}
    ...
    with |/.append style| and |/.append code|. Please refer to \href{https://tikz.dev/pgfkeys}{the PGF/TikZ manual, Section ``pgfkeys''} for details.
...
\end{codeexample}
    ...
    and some more. The math parser has been written by \href{https://tikz.dev/math}{Mark Wibrow and Till
    Tantau}, the FPU routines have been developed as part of
    \PGFPlots{}. The documentation for both parts can be found in~\href{https://tikz.dev/}{the PGF/TikZ manual}.
...
be found in \href{https://tikz.dev/}{the PGF/TikZ manual}.
...
\begin{commandlist}{%
    ...
    \meta{\textbackslash table or filename}. The input argument can be either a
...
\begin{command}{\foreach \meta{variables} |in| \meta{list} \marg{commands}}
    A powerful loop command provided by \Tikz, see \href{https://tikz.dev/pgffor}{the PGF/TikZ manual, Section ``Utilities''}.
    %
\begin{codeexample}[pre={\begin{lateximage}},post={\end{lateximage}}]
